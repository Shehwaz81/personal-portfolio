...
const Card = ({
  ...
  return (
    <div
      style={style}
      className={`w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl bg-gradient-to-br from-slate-900/60 to-slate-800/40 transform hover:-translate-y-1 rounded-2xl backdrop-blur-sm overflow-hidden ring-1 ring-slate-600/40 hover:drop-shadow-[0_0_0.3rem_cyan] hover:ring-cyan-500/50 hover:shadow-[0_8px_32px_rgba(6,182,212,0.15)] transition-all duration-300 mx-auto flex flex-col ${className}`}
    >
      <div className="relative overflow-hidden bg-slate-800/30 h-64 duration-450 hover:scale-105">
        <img
          src={img}
          alt={`${title} preview`}
