...
const Card = ({
    ...
    return (
        <div style={style} className={"flex flex-col justify-start max-w-full h-auto bg-gradient-to-br from-slate-900/60 to-slate-800/40 transform hover:-translate-y-1 rounded-2xl backdrop-blur-sm overflow-hidden ring-1 ring-slate-600/40 hover:drop-shadow-[0_0_0.3rem_cyan] hover:ring-cyan-500/50 hover:shadow-[0_8px_32px_rgba(6,182,212,0.15)] transition-all duration-300 ${className}"}>
            ...
            <div className="p-7">
                <h3 className="text-2xl font-bold bg-gradient-to-r from-white to-cyan-200 bg-clip-text text-transparent mb-4 text-center">
                    {title}
                </h3>

                <p className="text-slate-200 text-sm sm:text-base leading-relaxed text-center flex-grow mb-6">
                    {description}
                </p>
                ...
                <div className="flex gap-3 pt-5 border-t border-slate-600/40">
                    <a 
                        href={github}
                        target="_blank"
                    ...
                    >
                        <svg className="w-5 h-5 text-slate-300 group-hover:text-cyan-300 transition-colors" fill="currentColor" viewBox="0 0 24 24">
