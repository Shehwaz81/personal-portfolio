  ...
  const data = [
    {
      ...
      content: (
        <div>
            <p className="text-xs font-normal md:text-sm text-white">
    ...
    },
    {
        ...
        <div>
            ...
            <div className="grid grid-cols-2 gap-4 overflow-hidden p-5 scale-90">
                ...
                />
                <img
                src="/src/assets/presentationpic.jpg"
    ...
    return (
        <div id="exp" className='max-w-10xl'>
